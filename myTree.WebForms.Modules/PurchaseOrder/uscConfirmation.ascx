<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uscConfirmation.ascx.cs" Inherits="Procurement.PurchaseOrder.uscConfirmation" %>
...
<script>
    var listPOConfirm = <%=listPOConfirm%>;
            ...
            "aoColumns": [
                {
                    ...
                    , "mRender": function (d, type, row) {
                        return '<a href="/workspace/procurement/userconfirmation/detail.aspx?id=' + row.id + '" target="_blank">' + row.confirmation_code + '</a>';
                    }
                },
                { "mDataProp": "status" },
                { "mDataProp": "send_date" },
