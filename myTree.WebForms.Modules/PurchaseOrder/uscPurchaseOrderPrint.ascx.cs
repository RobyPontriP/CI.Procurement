...
{
    public partial class uscPurchaseOrderPrint : System.Web.UI.UserControl
    {
            ...
            if (!String.IsNullOrEmpty(page_id))
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dm in ds.Tables[1].Rows)
                    {
                        ...
                        if (Boolean.Parse(dm["vat_printable"].ToString()))
                        {
                        ...
                        if (!vat_printable)
                        {
                            vat_printable = Boolean.Parse(dm["vat_printable"].ToString());
                        }
