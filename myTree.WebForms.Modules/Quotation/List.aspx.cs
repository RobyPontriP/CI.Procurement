...
namespace myTree.WebForms.Modules.Quotation
{
    ...
    {
        protected string listQuo = string.Empty;
        ...
        private string moduleName = "QUOTATION";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    UserRoleAccess userRoleAccess = AccessControl.GetUserRoleAccess(AccessControlObjectEnum.ProcurementQuotationList);
                    ...
                    UserRoleAccess userRoleAccessEdittable = AccessControl.GetUserRoleAccess(AccessControlObjectEnum.ProcurementQuotation);
                    ...
                    DataSet ds = staticsQuotation.Main.GetList(startDate, endDate, status, cifor_office);
                    ...
                    if (ds.Tables.Count > 0)
                    {
                        ...
                        foreach (DataRow drM in ds.Tables[0].Rows)
                        {
                            ...
                            m.q_no = drM["q_no"].ToString();
                            m.rfq_id = drM["rfq_id"].ToString();
                        ...
                        listQuo = JsonConvert.SerializeObject(lm);
                    }
