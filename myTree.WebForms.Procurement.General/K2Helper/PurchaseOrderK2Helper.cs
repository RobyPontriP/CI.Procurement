...
namespace myTree.WebForms.Procurement.General.K2Helper
{
    ...
    //    public void SavePODataLogList(DataTable prData)
    //    {
    ...
    //        productDesc.Module = "PurchaseOrder";
    ...
    //    public static Dictionary<string, object> GetPOK2User(DataTable poData)
    //    {
    //        var prId = poData.Rows[0]["id"]?.ToString();
    //        var createdBy = poData.Rows[0]["created_by"]?.ToString();
    //        var title = poData.Rows[0]["system_code"]?.ToString();
    //        string prAmount = poData.Rows[0]["pr_amt"]?.ToString();
    //        string prType = poData.Rows[0]["pr_type"]?.ToString();
    //        string chrgCode = poData.Rows[0]["charge_code"]?.ToString();
    //        string requestor = poData.Rows[0]["requestor"]?.ToString();
    //        string requiredDate = poData.Rows[0]["required_date"]?.ToString();
    ...
    //        var approver = GetAllApproverByRelevantId(prId, "PurchaseOrder");
    ...
    //    public static List<K2ActivityUser> GetPOActivityUser(DataTable poObj)
    //    {
    //        var CreatedBy = poObj.Rows[0]["created_by"].ToString();
    //        var resquestor = poObj.Rows[0]["requestor_user_id"].ToString();
    //        var poId = poObj.Rows[0]["id"].ToString();
    //        var prType = poObj.Rows[0]["pr_type"].ToString().ToLower();
    //        var prAmount = poObj.Rows[0]["pr_amt"].ToString().ToLower();
    //        var dcsUser = poObj.Rows[0]["dcsUser"].ToString().ToLower();
    //        var dgUser = poObj.Rows[0]["dgUser"].ToString().ToLower();
    //        var bhUser = poObj.Rows[0]["bhUser"].ToString().ToLower();
    //        var procOffUser = poObj.Rows[0]["procOffUser"].ToString().ToLower();
    //        var financeUser = poObj.Rows[0]["financeUser"].ToString().ToLower();
    //        var paymentUser = poObj.Rows[0]["paymentUser"].ToString().ToLower();
    //        bool isFromRedirect = false;
    //        var PrTypeBefore = GetLatestPRTypeById(poId);
    ...
    //        {
    //            activityUserList.AddRange((AddUser(paymentUser, poId, 7, poObj))
    //            .Where(x => !activityUserList.Select(z => z.Username.ToLower()).Contains(x.UserId.ToLower()))
    ...
    //            if (isFromRedirect)
    //            {
    //                var procOffData = CheckProcurementOfficeUserInCurrentSequence(poId);
    ...
    //                        isReturnToInit = CheckIsHaveRevisionTask(poId);
    //                        if (isReturnToInit)
    //                        {
    //                            //checklast take action
    //                            DataTable lastVerif = CheckPRLastVerif(poId);
    //                            if (lastVerif != null)
    //                            {
    ...
    //                        {
    //                            activityUserList.AddRange((AddUser(existProcOfficeUser, poId, 5, poObj))
    //                            .Where(x => !activityUserList.Select(z => z.Username.ToLower()).Contains(x.UserId.ToLower()))
    ...
    //            if (isFromRedirect)
    //            {
    //                var finData = CheckFinanceInCurrentSequence(poId);
    ...
    //                    {
    //                        activityUserList.AddRange((AddUser(existpaymentUser, poId, 7, poObj))
    //                        .Where(x => !activityUserList.Select(z => z.Username.ToLower()).Contains(x.UserId.ToLower()))
    //                        .Select(x => new K2ActivityUser() { Username = x.UserId, ActivityID = 7 })
    //                        );
    //                    }
    ...
    //            activityUserList.AddRange((AddUser(procOffUser, poId, 5, poObj))
    //            .Where(x => !activityUserList.Select(z => z.Username.ToLower()).Contains(x.UserId.ToLower()))
    //            .Select(x => new K2ActivityUser() { Username = x.UserId, ActivityID = 5 })
    //            );
    //        }

    //        activityUserList.AddRange((AddUser(bhUser, poId, 4, poObj))
    ...
    //                {
    //                    activityUserList.AddRange((AddUser(dgUser, poId, 3, poObj))
    ...
    //                else
    //                {
    //                    activityUserList.AddRange((AddUser(dcsUser, poId, 2, poObj))
    //                        .Where(x => !activityUserList.Where(y => actIdToCompare.Contains(y.ActivityID)).Select(z => z.Username.ToLower()).Contains(x.UserId.ToLower()))
    ...
    //    public static List<K2ActivityUser> GetPOAllActivityUser(DataTable poObj)
    //    {
    //        var CreatedBy = poObj.Rows[0]["created_by"].ToString();
    //        var requestor = poObj.Rows[0]["requestor_user_id"].ToString();
    //        var poId = poObj.Rows[0]["id"].ToString();
    //        var prType = poObj.Rows[0]["pr_type"].ToString().ToLower();
    //        var prAmount = poObj.Rows[0]["pr_amt"].ToString().ToLower();
    //        var dcsUser = poObj.Rows[0]["dcsUser"].ToString().ToLower();
    ...
    //            if (!noNeedFinanceVerif.Contains(prType))
    //            {
    //                //activityUserList.AddRange((AddUser(financeUser, poId))
    //                //.Select(x => new K2ActivityUser() { Username = x.UserId, ActivityID = 6 })
    //                //);
    //            }
    ...
    //                    if (isFinanceExist)
    //                    {
    //                        //activityUserList.AddRange((AddUser(existfinanceUser, poId, 6))
    //                        //.Select(x => new K2ActivityUser() { Username = x.UserId, ActivityID = 6 })
    //                        //);
    //                    }
    //                }
    ...
    //    private static List<Participant> AddUser(string user, string poId = "", int actId = 0, DataTable prData = null)
    //    {
    //        List<Participant> listOfPart = new List<Participant>();
    ...
    //                        if (prData == null)
    //                        {
    //                            prData = staticsPurchaseOrder.Main.GetDataForK2(poId);
    //                        }
    ...
    //                        string prLeadUserIdOne = GetPOLeadByCode(statics.GetSetting("PRLEADONE")).Rows[0]["UserId"].ToString();
    //                        string prLeadUserIdTwo = GetPOLeadByCode(statics.GetSetting("PRLEADTWO")).Rows[0]["UserId"].ToString();
    ...
    //    private static List<ParticipantMapping> AddUserSubsMapping(string user, string poId = "", int actId = 0, DataTable prData = null)
    //    {
    ...
    //    private static bool isUserNameRequestor(string poId, string username)
    //    {
    //        var taData = staticsPurchaseOrder.Main.GetData(poId).Tables[0];
    ...
    //        var poData = staticsPurchaseOrder.Main.GetDataForK2(Id);
    ...
    //            var prType = poData.Rows[0]["pr_type"]?.ToString();
    ...
    //    public static DataTable GetPOLeadByCode(string code)
    //    {
    //        DataTable PIData = new DataTable();
    ...
    //        db.SPName = "sp_General_GetPOLeadByCode"; //////////////////////////////////////////////////////////////////////Perlu dibuatin SP
    ...
    //        List<ApproveState> aps = GetApprovedUser(prId, "PurchaseOrder", username, activityId.ToString(), 0); //ApprovedUser but need to reApprove
    //        if (aps.Count > 0)
    //        {
    //            isReAction = true;
    //        }
    ...
    //        {
    //            _actDesc = "You are " + action + " this request for budget holder of ";
    //        }
    //        else
    //        {
    ...
    //        DataTable taData = staticsPurchaseOrder.Main.GetDataForK2(prId);
    //        if (taData != null)
    //        {
    ...
    //                {
    //                    {1, "Initiator" },
    //                    {2, "Director, Corporate Services Approval" },
    ...
    //            var maxDataLogNextSeqNo = GetDataLogNextSeqNo(prId, "PurchaseOrder");
    ...
    //                Dictionary<string, string> oldGrantData = GetListOlderDataLog(prId, "PurchaseOrder");
    //                Dictionary<string, string> newGrantData = GetListCurrentDataLog(prId, "PurchaseOrder");
    ...
    //    public static List<K2ActivityUserMapping> GetPRAllActivityUserWithSubstitute(DataTable poObj)
    //    {
    //        var CreatedBy = poObj.Rows[0]["created_by"].ToString();
    //        var requestor = poObj.Rows[0]["requestor_user_id"].ToString();
    //        var poId = poObj.Rows[0]["id"].ToString();
    ...
    //        if (!noNeedFinance.Contains(prType))
    //        {
    //            activityUserList.AddRange((AddUserSubsMapping(paymentUser, poId, 7, poObj))
    //            .Select(x => new K2ActivityUserMapping() { Username = x.UserId, ActivityId = 7, Substitute = x.Substitute })
    //            );

    //            if (!noNeedFinanceVerif.Contains(prType))
    //            {
    //                //activityUserList.AddRange((AddUserSubsMapping(financeUser, poId, 6))
    ...
    //                    if (isProcOfficeUserExist && isAllowedToInsertPaymentUser)
    //                    {
    //                        activityUserList.AddRange((AddUserSubsMapping(existProcOfficeUser, poId, 5, poObj))
    ...
    //                if (isPaymentExist && isAllowedToInsertPaymentUser)
    //                {
    //                    activityUserList.AddRange((AddUserSubsMapping(existpaymentUser, poId, 7, poObj))
    //                    .Select(x => new K2ActivityUserMapping() { Username = x.UserId, ActivityId = 7, Substitute = x.Substitute })
    //                    );
    //                }
    ...
    //                if (isFinanceExist)
    //                {
    //                    //activityUserList.AddRange((AddUserSubsMapping(existfinanceUser, poId, 6))
    //                    //.Select(x => new K2ActivityUserMapping() { Username = x.UserId, ActivityId = 6, Substitute = x.Substitute })
    //                    //);
    //                }
    //            }
    ...
    //            activityUserList.AddRange((AddUserSubsMapping(procOffUser, poId, 5, poObj))
    //            .Select(x => new K2ActivityUserMapping() { Username = x.UserId, ActivityId = 5, Substitute = x.Substitute })
    //            );
    //        }


    //        activityUserList.AddRange((AddUserSubsMapping(bhUser, poId, 4, poObj))
    ...
    //                if (Convert.ToDecimal(prAmount) > 50000)
    //                {
    //                    activityUserList.AddRange((AddUserSubsMapping(dgUser, poId, 3, poObj))
    //                        .Select(x => new K2ActivityUserMapping() { Username = x.UserId, ActivityId = 3, Substitute = x.Substitute })
    //                        );
    //                }
    //                else
    //                {
    //                    activityUserList.AddRange((AddUserSubsMapping(dcsUser, poId, 2, poObj))
